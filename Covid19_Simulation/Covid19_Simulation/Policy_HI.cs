...
{
    public class Policy_HI : ILockdownPolicy
    {
        private Random rnd = new Random();

        //r0
        private int macroForCloseCulture = 4;
        private int macroForMedianCulture = 2;
        private int macroForRemoteCulture = 1;
        private int macroForHighDensity = 4;
        private int macroForMediumDensity = 2;
