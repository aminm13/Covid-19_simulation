...
{
    public class Policy_strict : ILockdownPolicy
    {
        private Random rnd = new Random();

        //r0
        private int macroForCloseCulture = 1;
        private int macroForMedianCulture = 1;
        private int macroForRemoteCulture = 1;
        private int macroForHighDensity = 3;
        private int macroForMediumDensity = 1;
        private int macroForLowDensity = 0;
        private int solitaryLifestyleAssumption = 4; //2-50%, 5-25% -- 1/4 that person will not transmit at all
